...
def avomod1(vp1=2192,vs1=818,rho1=2.16,vp2=1542,vs2=901,rho2=1.88,angmin=0,angmax=30,polarity='normal',black=False,method='shuey'):
    ...
    sigma1 = (vp1**2 -2*vs1**2) / 2*(vp1**2 - vs1**2)
    sigma2 = (vp2**2 -2*vs2**2) / 2*(vp2**2 - vs2**2)
    
    print('Poisson ratio layer 1: ', sigma1)
    print('Poisson ratio layer 2: ', sigma2)
